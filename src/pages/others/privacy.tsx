...
<center>
      ...
      <h1 style={{ textAlign: 'left' }}>Definitions</h1> 
        ...
        <ul style={{ textAlign: 'left' }}>
          ...
          <h1 style={{ textAlign: 'left' }}>Information Collection and Use</h1>
          ...
          <h1 style={{ textAlign: 'left' }}>Personal Data</h1>
          <p>Personally identifiable information may include, but is not limited to:</p>
          <li style={{ textAlign: 'left' }}>Email address</li>
          <li style={{ textAlign: 'left' }}>Your IP Address</li>
          <li style={{ textAlign: 'left' }}>Cookies and Usage Data</li>
        ...
        <ul>
          ...
          <h1>Legal Basis for Processing Personal Data under the General Data Protection Regulation (GDPR)</h1>
          ...
          Google, as a third party vendor, uses cookies to serve ads on our Service. Google's use of the DoubleClick cookie enables it and its partners to serve ads to our users based on their visit to our Service or other websites on the Internet.</p>
